...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  - It is a JavaScript Library used for building UI.

2. Describe component state.
   1. state is a JS object which holds information that influences the output of render.  State is managed within the component

3. Describe props.
   1. props are also a JS object that can influence the output of the render but props get passed to the component instead of inside it.


4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
   1. essentially they are anything that affects something outside of the scope of the current function thats being executed.
